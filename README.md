# [scikit-learn-korean](https://panda5176.github.io/scikit-learn-korean)
...
현재 페이지는 scikit-learn v1.2 문서 번역을 배포 중이며, [GitHub Pages](https://pages.github.com/)에서 [Cayman 테마](https://github.com/pages-themes/cayman) 및 [MathJax](https://www.mathjax.org/)와 함께 서비스되고 있습니다. 아래에 번역하고자 하는 상위 페이지의 목차가 있으며, 클릭 시 하위 페이지 또는 하위 페이지의 목록으로 연결됩니다. 모든 하위 페이지의 번역이 완료되지 않은 상위 페이지는 기울임체로 표기했습니다.
...
- *[자주 묻는 질문](faq) (원문: [FAQ](https://sciki